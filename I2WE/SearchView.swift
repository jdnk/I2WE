                ...
                LazyVStack {
                    ...
                    VStack {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            LazyHStack {
                                ForEach(0..<pref.pref.count) { p in
                                    Button(action: {
                                        prefSelector.contains(p) ? self.prefSelector.removeAll(where: { $0 == p }) : self.prefSelector.append(p)
                                    }) {
                                        Text("\(pref.pref[p]!)")
                                        .font(.caption)
                                        .foregroundColor(Color.white)
                    ...
                    VStack {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            LazyHStack {
                                ForEach(0..<mbti.mbti.count) { p in
                                    Button(action: {
                                        mbtiSelector.contains(p) ? self.mbtiSelector.removeAll(where: { $0 == p }) : self.mbtiSelector.append(p)
                                    }) {
                                        Text("\(mbti.mbti[p]!)")
                                        .font(.caption)
                                        .foregroundColor(Color.white)
                    ...
                    VStack {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack {
                                ForEach(0..<zodiac.zodiac.count) { p in
                                    Button(action: {
